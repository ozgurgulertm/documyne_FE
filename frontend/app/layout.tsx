...
export const metadata = {
  title: "Documyne - Get a Second Brain with Generative AI",
  description:
    "Documyne is your second brain in the cloud, designed to easily store and retrieve unstructured information.",
};
